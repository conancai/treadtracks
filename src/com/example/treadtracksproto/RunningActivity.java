...
//		mediaPlayer.setOnCompletionListener(this);
        ...
        String[] projection = {MediaStore.Audio.Media.TITLE, MediaStore.Audio.Media.ARTIST, MediaStore.Audio.Media.DATA, MediaStore.Audio.Media.ALBUM_ID};
        ...
        for(int i = 0; i < cursor.getCount(); i++){
            songData.add(new SongItem(this,
        ...
        adapter = new SongAdapter(this, R.layout.song_row_item, songData.toArray(new SongItem[0]));
...
//		});
    ...
    private void setNewSong(int i){
        ...
        try{
            ...
            st = new SoundTouchPlayable(new SongProgressListener(), item.getFilepath(), 0, bpm/100f, 0){
    ...
    private class SongProgressListener implements SoundTouchPlayable.OnProgressChangedListener{
        @Override
